...
/**
 * ARCHIVE — the original "Busan Meetups" board (8 seeded meetups).
 * Replaced by the live presence Connect screen at /connect.
 * Kept here (not a route — this is not page.tsx) so it can be restored
 * or its data reused. Not imported anywhere by default.
 */
...
export default function MeetupsArchive() {
